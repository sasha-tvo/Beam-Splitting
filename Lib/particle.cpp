...
void Prism::SetFacets(void)
{
	int* q;
	// the basal facets
	q = this->Gr[0]; q[0]=0; q[1]=1; q[2]=2; q[3]=3; q[4]=4; q[5]=5; q[6]=0; q[7]=-1;
	q = this->Gr[7]; q[0]=6; q[1]=11; q[2]=10; q[3]=9; q[4]=8; q[5]=7; q[6]=6; q[7]=-1;
	// the rectangular facets
	for(int i=1; i<=6; i++) {
		q=this->Gr[i]; q[0]=q[4]=i-1; q[1]=i+5; q[3]=i%6; q[2]=q[3]+6; q[5]=q[6]=q[7]=-1;
	}
}
//==============================================================================
...
{
	// basal facet (bottom)
	int* q=this->Gr[0]; q[0]=0; q[1]=1; q[2]=2; q[3]=3; q[4]=4; q[5]=5; q[6]=0; q[7]=-1;
	for(int i=1; i<=12; i++) { // ..and all other facets
		const int ij = i%6;
		q=this->Gr[i]; q[5]=q[6]=q[7]=-1;
...
void TaperedPrism::SetFacets(void)
{
	...
	q=this->Gr[0]; q[0]=0; q[1]=1; q[2]=2; q[3]=3; q[4]=4; q[5]=5; q[6]=0; q[7]=-1;
	q=this->Gr[19]; q[0]=18; q[1]=23; q[2]=22; q[3]=21; q[4]=20; q[5]=19; q[6]=18; q[7]=-1;
	for(int i=1; i<=18; i++) {  // the rectangular facets
		q=this->Gr[i];
		q[0]=q[4]=i-1; q[1]=i+5; q[3]=(i%6) ? i : i-6; q[2]=q[3]+6; q[5]=q[6]=q[7]=-1;
	} //*/
}
//==============================================================================
...
void CavityPrism::SetFacets(void)
{
	int* q;
	q = this->Gr[0];  q[0]=0;  q[1]=1;  q[2]=2;  q[3]=3;  q[4]=4; q[5]=5; q[6]=0; q[7]=-1;
	q = this->Gr[1];  q[0]=0;  q[1]=6;  q[2]=7;  q[3]=1;  q[4]=0; q[5]=q[6]=-1; q[7]=-1;
	q = this->Gr[2];  q[0]=1;  q[1]=7;  q[2]=8;  q[3]=2;  q[4]=1; q[5]=q[6]=-1; q[7]=-1;
	q = this->Gr[3];  q[0]=8;  q[1]=9;  q[2]=3;  q[3]=2;  q[4]=8; q[5]=q[6]=-1; q[7]=-1;
	q = this->Gr[4];  q[0]=3;  q[1]=9;  q[2]=10; q[3]=4;  q[4]=3; q[5]=q[6]=-1; q[7]=-1;
	q = this->Gr[5];  q[0]=4;  q[1]=10; q[2]=11; q[3]=5;  q[4]=4; q[5]=q[6]=-1; q[7]=-1;
	q = this->Gr[6];  q[0]=0;  q[1]=5;  q[2]=11; q[3]=6;  q[4]=0; q[5]=q[6]=-1; q[7]=-1;
	q = this->Gr[7];  q[0]=6;  q[1]=11; q[2]=12; q[3]=6;  q[4]=q[5]=q[6]=q[7]=-1;
	q = this->Gr[8];  q[0]=11; q[1]=10; q[2]=12; q[3]=11; q[4]=q[5]=q[6]=q[7]=-1;
	q = this->Gr[9];  q[0]=10; q[1]=9;  q[2]=12; q[3]=10; q[4]=q[5]=q[6]=q[7]=-1;
	q = this->Gr[10]; q[0]=9;  q[1]=8;  q[2]=12; q[3]=9;  q[4]=q[5]=q[6]=q[7]=-1;
	q = this->Gr[11]; q[0]=8;  q[1]=7;  q[2]=12; q[3]=8;  q[4]=q[5]=q[6]=q[7]=-1;
	q = this->Gr[12]; q[0]=7;  q[1]=6;  q[2]=12; q[3]=7;  q[4]=q[5]=q[6]=q[7]=-1;
}
//==============================================================================
